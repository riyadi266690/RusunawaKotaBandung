            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
                        data-bs-target="#addPenghuniModal" id="addPenghuniBtn">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="fetchNikDataBtn">
                                    <span id="nikSpinner" class="spinner-border spinner-border-sm d-none" role="status"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success && response.data) {
                        ...
                        nikErrorMessage.text('Data NIK ditemukan, silakan lengkapi data lainnya.').removeClass(
                        ...
                        nikErrorMessage.text(response.message ||
                            'Data NIK tidak ditemukan. Silakan isi data secara manual.').removeClass(
                ...
                error: function(xhr) {
                    let errorMessage =
                        'Terjadi kesalahan saat mencari data NIK. Silakan isi data secara manual.';
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 422) {
                        ...
                        Swal.fire('Gagal!',
                            'Terjadi kesalahan saat menyimpan data. Silakan cek konsol untuk detail.',
                            'error');
