                    ...
                    <div class="row">
                        <div class="col-md-4 pe-md-0">
                            <div class="auth-side-wrapper"
                                style="background-image: url({{ asset('assets/images/others/siraja.png') }})">
                        ...
                        <div class="col-md-8 ps-md-0">
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <a href="#" class="noble-ui-logo d-block mb-2">CHINA<span>SEHAT </span></a>
                                <h5 class="text-muted fw-normal mb-4">Hunian Nyaman dan Berkelanjutan</h5>
                                <form class="forms-sample form-adi" method="POST"
                                    ...
                                    <div>
                                        <button type="submit"
                                            class="btn btn-success me-2 mb-2 mb-md-0 button-adi">Masuk</button>
                                    </div>
                                    <a href="{{ route('pendaftaran.index') }}" class="d-block mt-3 text-muted">Belum Punya
...
=======
>>>>>>> 08758b319a7c8b0c9fe343ceda5e3fcd1e07988d
        </div>
